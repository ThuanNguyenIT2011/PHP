    ...
    <div class="container h-100">
        <div class="blog-banner">
            <div class="text-center">
                <h1>Shop <?php echo(print_info($info_cat['cat_title'])); ?></h1>
                ...
                <section class="lattest-product-area pb-40 category-list">
                    <div class="row">
                        <?php if(isset($list_item)){?>
                            <?php foreach ($list_item as $ele) { ?>
                            <div class="col-md-6 col-lg-4">
                                <div class="card text-center card-product">
                                    <div class="card-product__img">
                                        <img class="card-img" src="<?php echo "{$ele['product_thumb']}"; ?>" alt="">
                                        <ul class="card-product__imgOverlay">
                                            <li><button><i class="ti-search"></i></button></li>
                                            <li><button onclick="location.href='<?php echo $ele['url']; ?>'"><i class="ti-shopping-cart"></i></button></li>
                                            <li><button><i class="ti-heart"></i></button></li>
                                        </ul>
                                    </div>
                                    <div class="card-body">
                                        <!-- <p>Accessories</p> -->
                                        <h4 class="card-product__title"><a href="<?php echo "{$ele['url']}"; ?>"><?php echo $ele['product_title']; ?></a></h4>
                                        <p class="card-product__price"><?php echo currency_format($ele['price']); ?></p>
                                    </div>
                                </div>
                            </div>
                            <?php } ?>
