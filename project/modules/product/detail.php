		...
		<div class="row s_product_inner">
			<div class="col-lg-6">
				<div class="owl-carousel owl-theme s_Product_carousel">
					<div class="single-prd-item">
						<img class="img-fluid" src="<?php echo print_info($item['product_thumb_detail']); ?>" alt="">
					</div>
					<!-- <div class="single-prd-item">
							<img class="img-fluid" src="public/img/category/s-p1.jpg" alt="">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="public/img/category/s-p1.jpg" alt="">
						</div> -->
			...
			<div class="col-lg-5 offset-lg-1">
				<div class="s_product_text">
					<h3><?php echo print_info($item['product_title']); ?></h3>
					<h2><?php echo currency_format($item['price']); ?></h2>
					<ul class="list">
						<li><a class="active" href="#"><span>Category</span> : Household</a></li>
						<li><a href="#"><span>Availibility</span> : In Stock</a></li>
					</ul>
					<p><?php echo print_info($item['product_desc']); ?></p>
					<div class="product_count">
						...
						<a class="button primary-btn" href="<?php echo $item['url_add_cart']; ?>">Add to Cart</a>
					</div>
...
<section class="product_description_area">
	<div class="container">
		...
		<div class="tab-content" id="myTabContent">
			...
			<?php echo print_info($item['product_content']); ?>
			</div>
